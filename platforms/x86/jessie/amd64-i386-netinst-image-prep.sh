...
wget https://$giturl/platforms/x86/jessie/amd64-i386-netinst-allstar-install.sh -O ./test.sh



# DL firstboot script and put in in /srv
wget https:/$giturl/platforms/x86/jessie/amd64-i386-netinst-allstar-install.sh -O /srv/amd64-i386-netinst-allstar-install.sh
...
wget https:/$giturl/patches/patch-exim4 -O /tmp/patch-exim4
cd /etc/default/
